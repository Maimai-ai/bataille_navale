...
public class Win extends JDialog implements ActionListener, Runnable {
	...
	*/
	public Win(JFrame parent, String titre, String message, String image) {
		super(parent, titre);
        ...
        placementBoutons.add(this.rejouer);
		...
		this.rejouer.setForeground(new Color(255,53,53));
	...
	*/
	public void actionPerformed(ActionEvent e){
		...
		if (appuiesur == this.exit){
			this.parent.dispose();
			Thread test = new Thread(new Win());
			test.start();
		}
